...
public class MainActivity extends AppCompatActivity {
    ...
    public ChartData getData() {
        ...
        DataSet dataSet = new DataSet(new ColorDrawable(Color.BLUE), dataPoints);
...
//		dataPoints.add(new DataPoint("f", 5.0));
        DataSet dataSet = new DataSet(new ColorDrawable(Color.GREEN), dataPoints);
...
//		dataPoints2.add(new DataPoint("g", 7.0));
        DataSet dataSet2 = new DataSet(new ColorDrawable(Color.BLUE), dataPoints2);
...
//		dataPoints2.add(new DataPoint("f", 5.0));
//		dataPoints2.add(new DataPoint("g", 7.0));
        DataSet dataSet3 = new DataSet(new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP, new int[]{Color.TRANSPARENT, Color.MAGENTA}), dataPoints3);
    ...
    public ChartData getData3() {
        ...
        DataSet dataSet2 = new DataSet(new ColorDrawable(Color.GREEN), dataPoints2);
        ...
        DataSet dataSet3 = new DataSet(new ColorDrawable(Color.RED), dataPoints3);
